...
export default function SettingsPage() {
  ...
  const handleDarkMode = async (val) => {
    await setProfile({ ...profile, dark_mode: val });
  };
    ...
    <div className="bg-gray-50 min-h-screen w-full">
      <div className="max-w-lg mx-auto">
        <div className="flex items-center gap-3 px-5 pt-6 pb-4">
          <button onClick={() => navigate(-1)}><ChevronLeft size={24} className="text-gray-600" /></button>
        ...
        <div className="px-4 mb-4">
          ...
          <div className="bg-white rounded-2xl px-4 shadow-sm border border-gray-100 divide-y divide-gray-100">
            ...
            <MenuItem icon={<Mail size={18} className="text-gray-500" />} label="Contact Us" href="mailto:support@dosely.app" />
          </div>
        </div>
        ...
        <div className="px-4 mb-4">
          ...
          <div className="bg-white rounded-2xl px-4 shadow-sm border border-gray-100 divide-y divide-gray-100">
            <MenuItem icon={<FileText size={18} className="text-gray-500" />} label="Privacy policy" href="https://dosely.app/privacy" />
            <MenuItem icon={<FileText size={18} className="text-gray-500" />} label="Terms and conditions" href="https://dosely.app/terms" />
          </div>
        </div>
        ...
        <div className="px-4 mb-4">
          <div className="bg-white rounded-2xl px-4 shadow-sm border border-gray-100">
            <MenuItem icon={<MessageSquare size={18} className="text-gray-500" />} label="Leave feedback" href="mailto:feedback@dosely.app" />
          </div>
        </div>

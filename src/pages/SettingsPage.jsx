    ...
    <div className="bg-gray-50 dark:bg-gray-950 min-h-screen w-full">
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="px-4 mb-4">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl px-4 shadow-sm border border-gray-100 dark:border-gray-800 divide-y divide-gray-100 dark:divide-gray-800">

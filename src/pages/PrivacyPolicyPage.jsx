    ...
    <div className="bg-gray-950 min-h-screen w-full">
      ...
      <div className="max-w-lg mx-auto px-4 py-4">
        ...
        <Section title="4. Third-Party Sharing">
          <p>We do <span className="text-white font-semibold">not</span> sell, rent, or trade your personal or health data to any third party. We do not share your data with advertisers, data brokers, or analytics companies.</p>
        ...
        <Section title="5. Medical Disclaimer">
          ...
          <p className="text-white font-medium">Only your doctor can diagnose and treat medical problems. Always consult a qualified healthcare professional before making changes to your medication or treatment plan.</p>
        </Section>
        ...
        <Section title="6. Data Retention & Deletion">
          ...
          <p className="text-blue-400 font-medium mt-1">privacy@dosely.app <span className="text-gray-500 text-xs">(placeholder — replace with your actual contact)</span></p>
          <p>We will process deletion requests within 30 days.</p>
        </Section>

        <Section title="7. Contact">
          <p>For any privacy-related questions or concerns, contact us at:</p>
          <p className="text-blue-400 font-medium mt-1">privacy@dosely.app <span className="text-gray-500 text-xs">(placeholder)</span></p>
        </Section>

        <div className="py-6 text-center">
          <p className="text-xs text-gray-600">© 2026 Dosely · Placeholder privacy policy</p>
        </div>
      </div>
    </div>
  );

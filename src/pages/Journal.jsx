...
import { Settings, Plus, Smile, FileText, AlertTriangle, Zap, Star, Clock, Heart } from "lucide-react";
  ...
  return (
    <div className="min-h-screen w-full">
      ...
      <div className="max-w-3xl mx-auto">
        {filtered.length === 0 ?
        <div className="px-4">
            <div className="relative rounded-2xl overflow-hidden bg-white dark:bg-gray-900 shadow-sm border border-indigo-100 dark:border-gray-800 min-h-[200px]">
              <ScatteredFaces />
              <div className="relative z-10 p-8 pr-[50%] flex flex-col justify-center min-h-[200px]">
                <h3 className="text-xl font-bold text-indigo-700 dark:text-indigo-300 mb-2">No Journal Entries</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Record your thoughts, symptoms, and medication experiences.</p>
                <button onClick={openNew} className="px-5 py-3 bg-indigo-600 text-white rounded-xl font-semibold flex items-center gap-2 self-start">

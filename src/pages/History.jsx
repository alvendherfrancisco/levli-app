      ...
      <div className="max-w-3xl mx-auto pt-4 pb-4">
        ...
        {selectedDayKey && (
          <button onClick={() => setShowSideEffects(true)}
            className="relative overflow-hidden mx-4 mb-4 bg-white dark:bg-gray-900 rounded-2xl p-5 min-h-[210px] shadow-sm border border-gray-100 dark:border-gray-800 w-[calc(100%-2rem)] text-left">

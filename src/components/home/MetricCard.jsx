  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-xl p-2.5 shadow-sm border border-gray-100 dark:border-gray-800 min-h-[90px] overflow-hidden flex flex-col">
      <div className="flex items-center justify-between mb-2">
        ...
        <button onClick={onAdd} className="w-5 h-5 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors flex-shrink-0">
          <Plus size={11} className="text-gray-500 dark:text-gray-400" />
        </button>
      </div>
      <span className="text-[10px] text-gray-500 dark:text-gray-400 font-medium mb-1 leading-tight break-words">{label}</span>

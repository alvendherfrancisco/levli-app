    ...
    <div className="mx-auto mt-2 mb-2 w-[210px] sm:w-[240px] relative select-none">
      ...
      <div className="rounded-[38px] border-[7px] border-gray-700 bg-gray-900 shadow-2xl shadow-black/60 overflow-hidden relative">
        ...
        <div className="bg-white rounded-[32px] overflow-hidden relative">
          {/* Status bar */}
          <div className="bg-white flex items-center justify-between px-4 pt-2 pb-1 relative">
            ...
            <div className="flex items-center gap-1">
              <div className="flex gap-[2px] items-end h-2.5">
                ...
                <div className="w-[2px] h-2 bg-gray-500 rounded-sm" />
                <div className="w-[2px] h-2.5 bg-gray-800 rounded-sm" />
              </div>
              <span className="text-[7px] text-gray-600">●●</span>
            </div>
          </div>
          {/* Content */}
          <div className="text-gray-900 text-[9px] leading-tight" style={{ minHeight: 300 }}>
            {children}
          </div>
          {/* Home indicator */}

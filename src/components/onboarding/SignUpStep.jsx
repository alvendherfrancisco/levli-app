    ...
    return (
      <div className="flex flex-col flex-1">
        ...
        <button
          ...
          className="w-full py-4 rounded-full font-semibold text-base bg-indigo-600 text-white shadow-lg shadow-indigo-600/25 disabled:opacity-60 transition-all active:scale-95"
        >
          {loading ? (

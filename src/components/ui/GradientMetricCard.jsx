...
export default function GradientMetricCard({
  ...
  return (
    <button
      onClick={onClick}
      className={`relative overflow-hidden rounded-3xl bg-gradient-to-br ${gradient} p-5 text-left shadow-lg shadow-black/5 transition-all duration-300 active:scale-[0.98] hover:shadow-xl hover:shadow-black/10 ${className}`}
    >
